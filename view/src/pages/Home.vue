...
<template>
  <div class="absolute w-screen h-screen bg-no-repeat"
       style="background-image: url('/img/home-bg-0.jpg');background-size: 100% 100%">
    <div class="relative container mx-auto max-w-4xl h-full">
      ...
      <div class="py-10 font-msz">
        ...
        <span class="float-right text-3xl space-x-12 font-bold">
          <span
              ...
              @click="router.push('/artwork/search')">作品</span>
          <span class="cursor-pointer hover:text-yellow-800"
                @click="router.push('/char/search')">字库</span>
          <span class="cursor-pointer hover:text-yellow-800"
                @click="router.push('/artwork/search')">作品搜索</span>
          <span class="cursor-pointer hover:text-yellow-800"
                @click="router.push('/char/search')">字库搜索</span>
          <span class="cursor-pointer hover:text-yellow-800"
                @click="router.push('/char/select')">用户</span>
        </span>
      </div>
      <!--搜索栏-->
      <div class="h-16 w-full mt-16">
        ...
        <input type="button"
               value="搜索作品"
               @click="router.push('/artwork/search')"
